...
const deleteJob = async () => {
  try {
    const confirm = window.confirm("Are you sure you wnat to delete this job?");
    if (confirm) {
      ...
      <div class="grid grid-cols-1 md:grid-cols-70/30 w-full gap-6">
        <main>
          ...
          >
            ...
            >
              <i class="pi pi-map-marker text-sm text-orange-700 mr-2 mt-1"></i>
        ...
        <aside>
          ...
          <div class="bg-white p-6 rounded-lg shadow-md mt-6">
            ...
            <RouterLink
              ...
              class="bg-blue-500 hover:bg-blue-900 text-white text-center font-bold py-2 px-4 rounded-full w-full focus:outline-none focus:shadow-outline mt-4 block"
              >Edit Job</RouterLink
            >
